...
public class ExtractionProcessorTest {
  ...
  public void test() throws FileNotFoundException {
    ...
    // Add properties
    runner.setProperty(ExtractionProcessor.JNI_PATH, "/opt/local/lib");
    runner.setProperty(ExtractionProcessor.TESS_DATA, "/usr/local/Cellar/tesseract/3.04.01_1/share/tessdata/");
