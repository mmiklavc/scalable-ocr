...
public class AlmostSimpleRenderer extends AbstractRemoteRenderer {
    ...
    public List<PageRaster> run(Document document, int begin, int end)
        ...
        // prepare args
        // ** ADDED REDIRECTION OF OUTPUT TO SILENCE LOG NOISE **
        String[] gsArgs = {"-sstdout=%stderr", "-dQUIET", "-dNOPAUSE", "-dBATCH", "-dSAFER",
